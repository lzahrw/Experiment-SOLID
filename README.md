...
اایجاد کلاس جدید PhoneOrderService و پیاده‌سازی توابع مربوط به سفارش و پرداخت تلفنی (تغییرات ۱ و ۲ و ۳ در جدول اصلی).
تغییرات مربوط به تابع main برای افزودن روش سفارش و پرداخت تلفنی (تغییرات ۸ و ۹ در جدول اصلی).
بنابراین، تعداد تغییرات مورد نیاز در مجموع ۴ تغییر خواهد بود.
